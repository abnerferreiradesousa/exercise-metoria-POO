...
exports.destroy = exports.update = exports.create = exports.findPosition = exports.find = void 0;
...
exports.find = find;
const findPosition = (position) => __awaiter(void 0, void 0, void 0, function* () {
    const query = 'SELECT * FROM exercices.talker WHERE display_order=?';
    const [[result]] = yield connection_1.default.execute(query, [position]);
    return result;
});
exports.findPosition = findPosition;
const create = ({ name, age, position }) => __awaiter(void 0, void 0, void 0, function* () {
    const query = 'INSERT INTO exercises.talker (name, age, display_order) VALUES(?, ?, ?)';
    const [newTalker] = yield connection_1.default.execute(query, [name, age, position]);
    return newTalker.insertId;
});
exports.create = create;
const update = ({ id, position }) => __awaiter(void 0, void 0, void 0, function* () {
    const query = 'UPDATE exercices.talker SET display_order = ? WHERE id=?';
    yield connection_1.default.execute(query, [position, id]);
});
